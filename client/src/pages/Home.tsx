...
export default function Home() {
  ...
  const periods = {
    jan2026: {
      ...
      totalErrors: 690,
      data: [
        { market: "ARABIC", vg_accuracy: 78.15, vhs_accuracy: 88.87, vg_vhs_accuracy: 73.95, sample_count: 476, incorrect_count: 123, weekly_trend: [72.36, 69.47, 76.69, 78.65], avg_sample: 119 },
        { market: "CHINESE_MANDARIN", vg_accuracy: 86.06, vhs_accuracy: 97.39, vg_vhs_accuracy: 85.40, sample_count: 459, incorrect_count: 66, weekly_trend: [89.68, 85.09, 81.31, 84.82], avg_sample: 115 },
        { market: "GERMAN", vg_accuracy: 84.41, vhs_accuracy: 97.52, vg_vhs_accuracy: 83.17, sample_count: 404, incorrect_count: 68, weekly_trend: [86.21, 81.25, 84.11, 81.63], avg_sample: 101 },
        { market: "HUNGARIAN", vg_accuracy: 89.55, vhs_accuracy: 96.86, vg_vhs_accuracy: 88.15, sample_count: 287, incorrect_count: 34, weekly_trend: [88.14, 92.41, 82.43, 89.33], avg_sample: 72 },
        { market: "INDONESIAN", vg_accuracy: 88.95, vhs_accuracy: 94.98, vg_vhs_accuracy: 86.94, sample_count: 697, incorrect_count: 91, weekly_trend: [85.81, 86.96, 91.10, 84.66], avg_sample: 174 },
        { market: "MAGHREB", vg_accuracy: 92.04, vhs_accuracy: 97.12, vg_vhs_accuracy: 90.04, sample_count: 452, incorrect_count: 44, weekly_trend: [87.18, 91.18, 89.80, 92.08], avg_sample: 113 },
        { market: "MALAY", vg_accuracy: 88.09, vhs_accuracy: 95.32, vg_vhs_accuracy: 85.53, sample_count: 235, incorrect_count: 34, weekly_trend: [87.10, 74.60, 89.47, 92.45], avg_sample: 59 },
        { market: "PAKISTAN_OTHERS", vg_accuracy: 90.24, vhs_accuracy: 93.09, vg_vhs_accuracy: 86.18, sample_count: 492, incorrect_count: 67, weekly_trend: [80.28, 89.76, 88.46, 87.10], avg_sample: 123 },
        { market: "RUSSIAN", vg_accuracy: 90.03, vhs_accuracy: 98.11, vg_vhs_accuracy: 89.22, sample_count: 371, incorrect_count: 40, weekly_trend: [90.00, 88.73, 84.68, 93.94], avg_sample: 93 },
        { market: "TURKISH", vg_accuracy: 83.60, vhs_accuracy: 95.61, vg_vhs_accuracy: 81.76, sample_count: 433, incorrect_count: 78, weekly_trend: [71.88, 85.48, 78.10, 89.81], avg_sample: 108 },
        { market: "UKRAINIAN", vg_accuracy: 86.53, vhs_accuracy: 97.60, vg_vhs_accuracy: 86.53, sample_count: 334, incorrect_count: 45, weekly_trend: [79.57, 87.64, 91.36, 88.73], avg_sample: 84 },
      ]
    },
    feb2026: {
      label: 'February 2026',
